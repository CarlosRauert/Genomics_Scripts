...
gnomad_hg38 = readRDS('c:/Users/carlo/Documents/Charite/Promotion/Scripts_Git_Repos/Genomics_Scripts/GatSV/data/gnomAD.v4.hg38.rds')
gnomad_hg19 = readRDS('c:/Users/carlo/Documents/Charite/Promotion/Scripts_Git_Repos/Genomics_Scripts/GatSV/data/gnomAD.v4.hg19.liftover.rds')
LINE_dt_hg38 = readRDS('c:/Users/carlo/Documents/Charite/Promotion/Scripts_Git_Repos/Genomics_Scripts/GatSV/data/repeatmasker.hg38.LINE.bed')
SINE_dt_hg38 = readRDS('c:/Users/carlo/Documents/Charite/Promotion/Scripts_Git_Repos/Genomics_Scripts/GatSV/data/repeatmasker.hg38.SINE.bed')
LINE_dt_hg19 = readRDS('c:/Users/carlo/Documents/Charite/Promotion/Scripts_Git_Repos/Genomics_Scripts/GatSV/data/repeatmasker.hg19.LINE.bed')
SINE_dt_hg19 = readRDS('c:/Users/carlo/Documents/Charite/Promotion/Scripts_Git_Repos/Genomics_Scripts/GatSV/data/repeatmasker.hg19.SINE.bed')
hg19_genes = readRDS('c:/Users/carlo/Documents/Charite/Promotion/Scripts_Git_Repos/Genomics_Scripts/GatSV/data/gencode.genes.hg19.rds')
hg19_exons=readRDS('c:/Users/carlo/Documents/Charite/Promotion/Scripts_Git_Repos/Genomics_Scripts/GatSV/data/gencode.exons.hg19.rds')
hg38_genes=readRDS('c:/Users/carlo/Documents/Charite/Promotion/Scripts_Git_Repos/Genomics_Scripts/GatSV/data/gencode.genes.hg38.rds')
hg38_exons=readRDS('c:/Users/carlo/Documents/Charite/Promotion/Scripts_Git_Repos/Genomics_Scripts/GatSV/data/gencode.exons.hg38.rds')
reptimedata_hg19 = readRDS('c:/Users/carlo/Documents/Charite/Promotion/Scripts_Git_Repos/Genomics_Scripts/GatSV/data/reptime.hg19.rds')
reptimedata_hg38 = readRDS('c:/Users/carlo/Documents/Charite/Promotion/Scripts_Git_Repos/Genomics_Scripts/GatSV/data/reptime.hg38.rds')
scaling_mat <- fread("c:/Users/carlo/Documents/Charite/Promotion/Scripts_Git_Repos/Genomics_Scripts/GatSV/data/scalingmatrix.txt")

GaTSV <- readRDS("c:/Users/carlo/Documents/Charite/Promotion/Scripts_Git_Repos/Genomics_Scripts/GatSV/svm/GaTSV.rda") #svmobject


#running the classifier on example data
metadata <- fread("c:/Users/carlo/Documents/Charite/Promotion/Scripts_Git_Repos/Genomics_Scripts/GatSV/data/example_metadata.txt") #metadata file that contains the sample_ids (same as 'sample' input) and associated tp53_mutation_status
file_path <- "c:/Users/carlo/Documents/Charite/Promotion/Scripts_Git_Repos/Genomics_Scripts/GatSV/data/example.sv.vcf" #replace with desired vcf path
sample <- "example"

run_GaTSV(file_path,sample,n_cores=16,genome='hg19',output_path = 'c:/Users/carlo/Documents/Charite/Promotion/GatSV/Out')

process_file(file_path,sample,n_cores=16,genome="hg19",output_path='c:/Users/carlo/Documents/Charite/Promotion/GatSV/Out/Example')
...
vcf_path_ex="c:/Users/carlo/Documents/Charite/Promotion/Scripts_Git_Repos/Genomics_Scripts/GatSV/data/example.sv.vcf"
vcf_path="c:/Users/carlo/Documents/Charite/Promotion/GatSV/ACTN01020001T.purple.sv.vcf.gz"
